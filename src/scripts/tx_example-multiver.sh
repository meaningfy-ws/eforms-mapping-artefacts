...
for i in $(ls -dv mappings-1*); do
    ...
    cp -v data/${type}_24_maximal-${i/mappings-}.xml data/source.xml
    $rmlmapper_cmd -m mappings/* $additional_mappings mappings-common/* $i/* -s turtle > output-versioned/${type}_24_maximal-${i/mappings-}.ttl
